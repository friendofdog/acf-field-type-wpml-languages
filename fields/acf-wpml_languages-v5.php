...
class acf_field_wpml_languages extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*  var message = acf._e('wpml_languages', 'error');
		*/
		
		$this->l10n = array(
			// 'error'	=> __('Error! Please enter a higher value', 'acf-wpml_languages'),
		);
	...
	*/
	...
	function render_field( $field ) {
		...
		$attrs['class'] .=  ' acf-wpml_languages';
		...
		<select <?php echo implode( ' ', array_map(function($val, $key) { return sprintf( '%1$s="%2$s"', $key, esc_attr($val) ); }, $attrs, array_keys( $attrs ))); ?>>
			...
			<option value=""><?php if( !$field['ui'] ): ?>- <?php esc_html_e('Select a language', 'acf-wpml_languages'); ?> -<?php endif; ?></option>
			<?php endif; ?>
			...
			foreach ($languages as $language) {
				...
				if ( $language['tag'] !== 'old_zh-hans' ) {
					?><option value=<?php echo '"' . $language['name'] . '"'; if($language['tag'] == $field['value']): ?> selected="selected"<?php endif; ?>><?php echo $language['name']; ?></option><?php
				}
	...
	*/
	...
	function input_admin_enqueue_scripts() {
		...
		// register & include JS
		wp_register_script( 'acf-input-wpml_languages', "{$url}assets/js/input.js", array('acf-input'), $version );
		wp_enqueue_script('acf-input-wpml_languages');
		
		
		// register & include CSS
		wp_register_style( 'acf-input-wpml_languages', "{$url}assets/css/input.css", array('acf-input'), $version );
		wp_enqueue_style('acf-input-wpml_languages');
	...
	*/
	...
	function validate_value( $valid, $value, $field, $input ){
		...
		if( $value < $field['custom_minimum_setting'] )
		{
			$valid = __('The value is too little!','acf-wpml_languages'),
		}
